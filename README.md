...
**API Integrations:** Integrates Open-Meteo API for real-time weather forecast, and Google Gemini API to normalize user interests and generate personalized destination recommendations.
...
**Destination Ranking:** Computes the Jaccard Similarity score between the user's normalized interests and each destination's associated interests.
